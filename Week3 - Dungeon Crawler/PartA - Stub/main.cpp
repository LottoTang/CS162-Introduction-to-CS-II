...
int main()
{
    ...
    //{
        ...
        //do
        //{
        cout << "start do-while loop for the game" << endl;
        ...
        //} while (!game_end);
        cout << "stop do-while loop for the game if game_end from checkMove == true" << endl;

        //display result when game ends
        cout << endl;

        cout << "Display game end message and score" << endl;
    ...
    cout << "repeat the game if true, exit if false" << endl;
